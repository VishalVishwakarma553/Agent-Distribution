  ...
  return (
    <div className='bg-gray-400 h-16 flex justify-between px-4 items-center'>
        ...
        <ul className='flex gap-2 items-center'>
            <li><button className='px-3 py-2 text-sm font-semibold bg-gray-500 hover:shadow-md hover:bg-gray-600 rounded-md duration-150 cursor-pointer'>Add Agent</button></li>
